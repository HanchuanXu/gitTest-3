...
public class TurtleSoupTest {
    ...
    public void convexHullTest() {
    	...
    	assertTrue(isSetEqual(convexHull,TurtleSoup.convexHull(points)));
    	...
    	Set<Point> resultPoints=TurtleSoup.convexHull(points);
    	...
    	for (Point point:resultPoints)
    		 System.out.println(point.x()+"  "+point.y());
    	System.out.println("covexhull");
    	for (Point point:convexHull)
   		 System.out.println(point.x()+"  "+point.y());
    	
    	System.out.println(isSetEqual(convexHull,TurtleSoup.convexHull(points)));		
    }
